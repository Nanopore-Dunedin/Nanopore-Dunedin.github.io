...
Any datasets we download today will be in this [directory](https://cloudstor.aarnet.edu.au/plus/f/1603892243).  
...
Download the DCM E cocli data set. The data was run on the standard ligation 1D kit with R 9.4 chemistry. The DNA has been PCR amplified.
